...
- Registering and viewing customer complaints.
...
The project is limited to a local console-based application and does not currently include database storage, web-based access, authentication or external APIs.

---

## 3. Target Users
The system is intended for users who need a simple way to manage and analyze customer complaints.
...
- Select predefined complaint categories and issues.
...
- Calculate average customer rating.
- Generate a complete complaint report.
